...
inherit edo pnpm python-single-r1 systemd tmpfiles
...
SLOT="0"
KEYWORDS="~amd64"
IUSE="audit mysql postgres remote-redis +sqlite"
REQUIRED_USE="
	${PYTHON_REQUIRED_USE}
...
src_prepare() {
	...
	edo cp paperless.conf.example paperless.conf
	sed \
...
src_compile() {
	...
	pushd src &>/dev/null || die
		# paperless.settings (loaded by manage.py) attempts to load
