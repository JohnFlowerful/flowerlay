...
inherit eutils l10n toolchain-funcs user git-r3

DESCRIPTION="IRC fileserver using DCC"
HOMEPAGE="http://iroffer.dinoex.net/"
EGIT_REPO_URI="git://github.com/dinoex/iroffer-dinoex.git"
...
myloc() {
	...
	# these help-admin files aren't in the GitHub repo for some reason
	dodoc ${FILESDIR}/help-admin-${1}.txt
