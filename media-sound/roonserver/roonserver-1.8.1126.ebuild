...
SRC_URI="http://download.roonlabs.com/builds/RoonServerLegacy_linuxx64_${MY_PV_MAJOR}00${MY_PV_MINOR}0${MY_PV_BUILD}.tar.bz2"
...
src_install() {
	...
	executables=$(file_to_prepended_string executables_legacy "/opt/RoonServer")
