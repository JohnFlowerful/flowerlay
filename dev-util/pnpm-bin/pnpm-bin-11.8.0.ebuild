...
SRC_URI="https://registry.npmjs.org/${MY_PN}/-/${MY_PN}-${PV}.tgz"
...
src_install(){
	local install_dir="/usr/$(get_libdir)/node_modules/${MY_PN}" path shebang
	insinto "${install_dir}"
	doins -r .
	dosym "../$(get_libdir)/node_modules/${MY_PN}/bin/pnpm.cjs" "/usr/bin/pnpm"
	dosym "../$(get_libdir)/node_modules/${MY_PN}/bin/pnpx.cjs" "/usr/bin/pnpx"
